...
module ram_module #(
   ...
   output wire [Dbits-1 : 0] cpu_readdata,   // Data read from memory (asynchronously, i.e., continuously)
   ...
   assign cpu_readdata = mem[cpu_addr];                  // Memory read: read continuously, no clock involved
